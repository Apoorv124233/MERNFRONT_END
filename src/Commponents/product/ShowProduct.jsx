  ...
  return (
    <>
      <div className="container  d-flex justify-content-center align-items-center p-3">
        <div className="row container d-flex justify-content-center align-items-center p-3 my-5">
          {products?.map((product) => (
            <div
              key={product._id}
              className=" my-3 col md-4 d-flex justify-content-center align-items-center p-3"
            >
              <div
